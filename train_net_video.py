...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.INPUT.DATASET_MAPPER_NAME == "video_instance_with_temp_coords":
            mapper = YTVISDatasetMapperWithCoords(cfg, is_train=True)
        else:
